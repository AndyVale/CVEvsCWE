...
*   **KEV analysis** How many CVE are in the Known Exploited Vulnerabilities? i.e. we are sure they have been exploited

### Notes

https://www.cve.org/resourcessupport/allresources/cnarules 5.1.7. Explain that CVE-CWE association is not mandatory, but it is encouraged.

Mapping of vulnerabilities to CVE:
*  Base - ALLOWED
*  Variant - ALLOWED
*  Compound - ALLOWED
*  Class - ALLOWED but Base is Preferred
*  Pillar - DISCOURAGED 